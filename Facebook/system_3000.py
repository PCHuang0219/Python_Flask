...
####################################################################################################
"""
Module Name: system_3000.py
Purpose    : Execute system-3000 test case
...
class System_3000(Script):
  def __init__(self, dut, job_id = "", image_server = 'None'):
    ...
    purpose = ['Combine diagnostic test item :',
                ...
                '     162. Check FPGA PCI-E bus error',
                '     156. The Test for FPGA MDIO 16Q',
  ...
  def run(self):
    ...
    retstr = self.__COMe_SSH.sendCmd('python /usr/local/accton/bin/diag_api.py 158 normal').splitlines()
    if "PASS" in retstr[-1]:
